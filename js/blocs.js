            ...
            if ((e.stopPropagation(), $(this).hasClass("selected-nav")))
                ...
                ($(".content-tint").length = -1),
                    ...
                    i
                        ...
                        .wrap('<div class="blocsapp-special-menu ' + n + '"><blocsnav class="' + c + '">'),
                    $("blocsnav").prepend(
                    ...
                    $(".blocsapp-special-menu blocsnav").hasClass("fullscreen-nav")
                        ? ((o = "fadeIn"), (s = 100))
                        : $(".blocsapp-special-menu").hasClass("nav-invert") && (o = "fadeInLeft"),
            ...
            $(this)
                ...
                .each(function (e) {
                    (fillPadding = 2 * parseInt($(this).css("padding-top"))),
                        (fillBodyHeight = t.hasClass("bloc-group")
...
function scrollToTarget(e) {
    1 == e
        ...
        : 2 == e
        ? (e = $(document).height())
        : ((e = $(e).offset().top), $(".sticky-nav").length && (e -= $(".sticky-nav .navbar-header").height())),
...
function stickyNavToggle() {
    ...
    if ($(".sticky-nav").hasClass("fill-bloc-top-edge")) {
        ...
        "rgba(0, 0, 0, 0)" == a && (a = "#FFFFFF"),
            ...
            (e = $(".sticky-nav").height()),
            (t = "sticky animated fadeInDown");
    }
    $(window).scrollTop() > e
        ? ($(".sticky-nav").addClass(t),
          "sticky" == t && $(".page-container").css("padding-top", $(".sticky-nav").height()))
    ...
    window.targetLightbox,
        ...
        $(document).on("click", ".next-lightbox, .prev-lightbox", function (e) {
            ...
            targetLightbox.attr("data-gallery-id") &&
                ((a = $('a[data-gallery-id="' + (t = targetLightbox.attr("data-gallery-id")) + '"]').index(
                    targetLightbox
                )),
                (i = $('a[data-gallery-id="' + t + '"]').eq(a + 1))),
                $(this).hasClass("prev-lightbox") &&
                    ((i = $('a[data-gallery-id="' + t + '"]').eq(a - 1)),
                    "no-gallery-set" == t && (i = $("a[data-lightbox]").eq(a - 1)));
            ...
            (targetLightbox = i),
                ...
                "no-gallery-set" == t
                    ? ($("a[data-lightbox]").index(i) != $("a[data-lightbox]").length - 1 && $(".next-lightbox").show(),
                      $("a[data-lightbox]").index(i) > 0 && $(".prev-lightbox").show())
                    : ($('a[data-gallery-id="' + t + '"]').index(i) != $('a[data-gallery-id="' + t + '"]').length - 1 &&
                          $(".next-lightbox").show(),
                      $('a[data-gallery-id="' + t + '"]').index(i) > 0 && $(".prev-lightbox").show());
        });
}
...
function addKeyBoardSupport() {
    $(window).keydown(function (e) {
        37 == e.which
            ...
            : 39 == e.which && $(".next-lightbox").is(":visible") && $(".next-lightbox").click();
    });
}
