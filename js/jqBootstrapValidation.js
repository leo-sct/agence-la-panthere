    ...
    var t = [],
        e = {
                    ...
                    return (
                        a(l).bind("submit", function (t) {
                            ...
                            n.trigger("submit.validation").trigger("validationLostFocus.validation"),
                                ...
                                i
                                    ? (r.options.preventSubmit && t.preventDefault(),
                                      e.addClass("error"),
                                      a.isFunction(r.options.submitError) &&
                                          r.options.submitError(e, t, n.jqBootstrapValidation("collectErrors", !0)))
                                    : (e.removeClass("error"),
                                      a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(e, t));
                        }),
                        this.each(function () {
                            var e = a(this),
                            ...
                            if (
                                (!l.length &&
                                    ...
                                    ((l = a('<div class="help-block" />')), o.append(l), t.push(l[0])),
                                r.options.sniffHtml)
                            ) {
                                var c = "";
                                if (
                                ...
                                void 0 !== e.attr("maxlength") &&
                                    ...
                                    void 0 !== e.attr("type") &&
                                        ...
                                        e.data("validationNumberMessage") && (c = e.data("validationNumberMessage")),
                            ...
                            a.each(s, function (t, n) {
                                ...
                                if (
                                    ...
                                    a.each(r.validatorTypes, function (t, r) {
                                        void 0 === h[t] && (h[t] = []),
                                            d ||
                                                void 0 === e.data("validation" + n + i(r.name)) ||
                                                (h[t].push(a.extend(!0, { name: i(r.name), message: o }, r.init(e, n))),
                                                (d = !0));
                                    }),
                                    ...
                                    "shortcut" === c
                                        ...
                                        : a.each(r.validatorTypes, function (t, o) {
                                              void 0 === h[t] && (h[t] = []),
                                                  d ||
                                                      c !== t.toLowerCase() ||
                                                      (e.data("validation" + n + i(o.name), s[o.name.toLowerCase()]),
                                                      h[c].push(a.extend(s, o.init(e, n))),
                                                      (d = !0));
                                          });
                                }
                                    ...
                                    return (
                                        a.each(h, function (t, n) {
                                            (o ||
                                                o.length ||
                                                (i && i.includeEmpty) ||
                                                (r.validatorTypes[t].blockSubmit && i && i.submitting)) &&
            ...
            validatorTypes: {
                callback: {
                    ...
                    validate: function (a, t, e) {
                        ...
                        if (!0 === e.lastFinished) {
                            ...
                            !(function a(t, e) {
                                for (
                                    var i = Array.prototype.slice.call(arguments).splice(2),
                                        n = t.split("."),
                                        o = n.pop(),
                                        r = 0;
                                    r < n.length;
                ...
                max: {
                    ...
                    validate: function (a, t, e) {
                        return (
                            (parseFloat(t, 10) > parseFloat(e.max, 10) && !e.negative) ||
                            (parseFloat(t, 10) <= parseFloat(e.max, 10) && e.negative)
                        );
                    },
                },
                ...
                maxchecked: {
                    ...
                    validate: function (a, t, e) {
                        return (
                            (e.elements.filter(":checked").length > e.maxchecked && !e.negative) ||
                            (e.elements.filter(":checked").length <= e.maxchecked && e.negative)
                        );
                    },
                    blockSubmit: !0,
                ...
                minchecked: {
                    ...
                    validate: function (a, t, e) {
                        return (
                            (e.elements.filter(":checked").length < e.minchecked && !e.negative) ||
                            (e.elements.filter(":checked").length >= e.minchecked && e.negative)
                        );
                    },
                    blockSubmit: !0,
        ...
        n = function (t) {
            var e = t.val(),
                i = t.attr("type");
            return (
                "checkbox" === i && (e = t.is(":checked") ? e : ""),
                "radio" === i && (e = a('input[name="' + t.attr("name") + '"]:checked').length > 0 ? e : ""),
                e
            );
        };
