 ...
 */ !(function (e) {
    "function" == typeof define && define.amd && define.amd.jQuery
        ? define(["jquery"], e)
        : e("undefined" != typeof module && module.exports ? require("jquery") : jQuery);
})(function (e) {
    "use strict";
    function n(n) {
        return (
    ...
    function t(n, t) {
            ...
            if (!(!(!0 !== eE.data(m + "_intouch")) || e(n.target).closest(t.excludedElements, eE).length > 0)) {
                ...
                if (!a.pointerType || "mouse" != a.pointerType || 0 != t.fallbackToMouseEvents) {
                    ...
                    return (
                        ...
                        G(),
                        J(0, p),
                        !c || ex === t.fingers || t.fingers === w || C()
                            ? ((eO = el()),
                              2 == ex && (J(1, c[1]), (e$ = ev = er(eS[0].start, eS[1].start))),
                              (t.swipeStatus || t.pinchStatus) && (u = A(a, ey)))
                            : (u = !1),
                        !1 === u
                            ? (A(a, (ey = y)), u)
                            : (t.hold &&
        ...
        function D(n) {
            ...
            if (ey !== E && ey !== y && !Z()) {
                ...
                if (
                    ...
                    2 == ex &&
                        (0 == e$
                            ? (J(1, d[1]), (e$ = ev = er(eS[0].start, eS[1].start)))
                            : (K(d[1]), (ev = er(eS[0].end, eS[1].end)), (e_ = (eS[0].end, eS[1].end, ew < 1 ? u : a))),
                    ...
                    if (
                        ...
                        (function e(n, a) {
                            if (!1 !== t.preventDefaultEvents) {
                                if (t.allowPageScroll === s) n.preventDefault();
                                    ...
                                    switch (a) {
                                        case r:
                                            ((t.swipeLeft && u) || (!u && t.allowPageScroll != $)) &&
                                                n.preventDefault();
                                            break;
                                        case i:
                                            ((t.swipeRight && u) || (!u && t.allowPageScroll != $)) &&
                                                n.preventDefault();
                                            break;
                                        case l:
                        ...
                        (eh =
                            ((S = _.start),
                            (O = _.end),
                            Math.round(Math.sqrt(Math.pow(O.x - S.x, 2) + Math.pow(O.y - S.y, 2))))),
                        (ed = et()),
                        (m = ef),
                        (P = eh),
                        ...
                        if (t.triggerOnTouchLeave) {
                            var S,
                                ...
                                I =
                                    ...
                                    {
                                        left: L.left,
                                        right: L.left + D.outerWidth(),
                                        top: L.top,
                                        bottom: L.top + D.outerHeight(),
                                    });
                            x = ((R = _.end), (k = I), R.x > k.left && R.x < k.right && R.y > k.top && R.y < k.bottom);
                        }
                        !t.triggerOnTouchEnd && x ? (ey = U(b)) : t.triggerOnTouchLeave && !x && (ey = U(E)),
                            (ey != y && ey != E) || A(p, ey);
                    }
                } else A(p, (ey = y));
                !1 === h && A(p, (ey = y));
        ...
        function U(e) {
            ...
            return (
                !r || l
                    ? (n = y)
                    : i && e == b && (!t.triggerOnTouchEnd || t.triggerOnTouchLeave)
                    ? (n = E)
                    : !i && e == E && t.triggerOnTouchLeave && (n = y),
                n
            );
        }
        function A(e, n) {
            ...
            return (
                ...
                z() && W() && !1 !== r
                    ? (r = M(e, n, g))
                    : ed > t.longTapThreshold && eh < T && t.longTap && !1 !== r
                    ? (r = M(e, n, d))
                    : !((1 === ex || !x) && (isNaN(eh) || eh < t.threshold)) || !V() || !1 === r || (r = M(e, n, f)),
                n === y && R(e),
                n === E && ((i && i.length) || R(e)),
                r
            );
        ...
        function M(n, s, c) {
            ...
            if (c == p) {
                if (
                    (eE.trigger("swipeStatus", [s, ef || null, eh || 0, ed || 0, ex, eS, eg]),
                    t.swipeStatus &&
                        !1 === ($ = t.swipeStatus.call(eE, n, s, ef || null, eh || 0, ed || 0, ex, eS, eg)))
                )
                    return !1;
                if (s == E && F()) {
                    if (
                        (clearTimeout(eR),
                        clearTimeout(ek),
                        eE.trigger("swipe", [ef, eh, ed, ex, eS, eg]),
                        t.swipe && !1 === ($ = t.swipe.call(eE, n, ef, eh, ed, ex, eS, eg)))
                    )
                        return !1;
                    switch (ef) {
                        case r:
                            eE.trigger("swipeLeft", [ef, eh, ed, ex, eS, eg]),
                                t.swipeLeft && ($ = t.swipeLeft.call(eE, n, ef, eh, ed, ex, eS, eg));
                            break;
                        case i:
                            eE.trigger("swipeRight", [ef, eh, ed, ex, eS, eg]),
                                t.swipeRight && ($ = t.swipeRight.call(eE, n, ef, eh, ed, ex, eS, eg));
                            break;
                        case l:
                            eE.trigger("swipeUp", [ef, eh, ed, ex, eS, eg]),
                                t.swipeUp && ($ = t.swipeUp.call(eE, n, ef, eh, ed, ex, eS, eg));
                            break;
                        case o:
                            eE.trigger("swipeDown", [ef, eh, ed, ex, eS, eg]),
                                t.swipeDown && ($ = t.swipeDown.call(eE, n, ef, eh, ed, ex, eS, eg));
                    }
                }
            }
            if (c == h) {
                if (
                    (eE.trigger("pinchStatus", [s, e_ || null, eT || 0, ed || 0, ex, ew, eS]),
                    t.pinchStatus &&
                        !1 === ($ = t.pinchStatus.call(eE, n, s, e_ || null, eT || 0, ed || 0, ex, ew, eS)))
                )
                    return !1;
                if (s == E && q())
                    switch (e_) {
                        case a:
                            eE.trigger("pinchIn", [e_ || null, eT || 0, ed || 0, ex, ew, eS]),
                                t.pinchIn && ($ = t.pinchIn.call(eE, n, e_ || null, eT || 0, ed || 0, ex, ew, eS));
                            break;
                        case u:
                            eE.trigger("pinchOut", [e_ || null, eT || 0, ed || 0, ex, ew, eS]),
                                t.pinchOut && ($ = t.pinchOut.call(eE, n, e_ || null, eT || 0, ed || 0, ex, ew, eS));
                    }
            }
            return (
                c == f
                      ...
                      W() && !z()
                          ? ((eL = el()),
                            (eR = setTimeout(
                                e.proxy(function () {
                                    (eL = null),
                                        eE.trigger("tap", [n.target]),
                                        t.tap && ($ = t.tap.call(eE, n, n.target));
                                }, this),
                    ...
                    ? (s !== y && s !== E) ||
                      ...
                      clearTimeout(ek),
                      (eL = null),
                      eE.trigger("doubletap", [n.target]),
                      t.doubleTap && ($ = t.doubleTap.call(eE, n, n.target)))
                    : c == d &&
                      ((s !== y && s !== E) ||
                          (clearTimeout(eR),
                          (eL = null),
                          eE.trigger("longtap", [n.target]),
                          t.longTap && ($ = t.longTap.call(eE, n, n.target)))),
                $
            );
        }
        function j() {
        ...
        function B(e) {
            eE &&
                (!0 === e
                    ? (eE.bind(eu, D), eE.bind(es, L), ec && eE.bind(ec, k))
                    : (eE.unbind(eu, D, !1), eE.unbind(es, L, !1), ec && eE.unbind(ec, k, !1)),
                eE.data(m + "_intouch", !0 === e));
        }
        function J(e, n) {
        ...
        function K(e) {
            ...
            return (
                ...
                (r.last.x = r.end.x),
                (r.last.y = r.end.y),
                (r.end.x = e.pageX || e.clientX),
                (r.end.y = e.pageY || e.clientY),
                r
            );
        }
        function ee(e) {
        ...
        function ei(e, n) {
            ...
            var t,
                ...
                f =
                    ...
                    (c = n),
                    (p = u.x - c.x),
                    (h = Math.round((180 * Math.atan2(c.y - u.y, p)) / Math.PI)) < 0 && (h = 360 - Math.abs(h)),
                    h);
            return f <= 45 && f >= 0
                ? r
                : f <= 360 && f >= 315
