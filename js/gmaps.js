     ...
     */ var t,
        ...
        a = function (t, o) {
            ...
            if (Array.prototype.map && t.map === Array.prototype.map)
                ...
                for (n = 0; n < i; n++)
                    (callback_params = r).splice(0, 0, t[n]), s.push(o.apply(this, callback_params));
            return s;
        },
        l = function (t) {
            var o,
        ...
        c = function (t, o) {
            ...
            for (n = 0; n < t.length; n++)
                t[n] instanceof google.maps.LatLng ||
                    (t[n].length > 0 && "object" == typeof t[n][0] ? (t[n] = c(t[n], o)) : (t[n] = p(t[n], o)));
            return t;
        },
        h = function (t, o) {
            var n,
            ...
            (s = function (t) {
                ...
                google.maps.event.addListener(this.map, "rightclick", function (o) {
                    t.rightclick && t.rightclick.apply(this, [o]),
                        void 0 != window.context_menu[a.el.id].map && a.buildContextMenu("map", o);
                }),
    ...
    return (
        ...
        (f.prototype.removeControl = function (t) {
            ...
            for (o = 0; o < this.controls.length; o++)
                this.controls[o] == t && ((n = this.controls[o].position), this.controls.splice(o, 1));
            if (n)
        ...
        (f.prototype.createMarker = function (t) {
            ...
            if (((l.fences = r), t.infoWindow)) {
                ...
                for (
                    var p = ["closeclick", "content_changed", "domready", "position_changed", "zindex_changed"], c = 0;
                    c < p.length;
                    c++
                )
                    !(function (o, n) {
            ...
            return (
                ...
                google.maps.event.addListener(l, "rightclick", function (n) {
                    (n.marker = this),
                        ...
                        void 0 != window.context_menu[o.el.id].marker && o.buildContextMenu("marker", n);
                }),
                l.fences &&
        ...
        (f.prototype.drawPolygon = function (t) {
            ...
            t.hasOwnProperty("useGeoJSON") && (o = t.useGeoJSON),
                ...
                t.paths.length > 0 && t.paths[0].length > 0 && (t.paths = l(a(t.paths, c, o)));
            for (
        ...
        (f.prototype.getElevations = function (t) {
            (t = i({ locations: [], path: !1, samples: 256 }, t)).locations.length > 0 &&
        ...
        (f.prototype.travelRoute = function (t) {
            if (t.origin && t.destination)
                ...
                for (var o, n = t.route.legs[0].steps, r = 0; (o = n[r]); r++) (o.step_number = r), t.step(o);
        }),
        ...
        (f.staticMapURL = function (t) {
            ...
            if (i)
                for (var u = 0; u < i.length; u++) {
                    var d = [];
                    i[u].featureType && d.push("feature:" + i[u].featureType.toLowerCase()),
                        i[u].elementType && d.push("element:" + i[u].elementType.toLowerCase());
        ...
        (f.on = function (t, o, n) {
            if (-1 == f.custom_events.indexOf(t))
                return o instanceof f && (o = o.map), google.maps.event.addListener(o, t, n);
        ...
        (f.off = function (t, o) {
            -1 == f.custom_events.indexOf(t)
                ? (o instanceof f && (o = o.map), google.maps.event.clearListeners(o, t))
                : (o.registered_events[t] = []);
        }),
        (f.once = function (t, o, n) {
            if (-1 == f.custom_events.indexOf(t))
                return o instanceof f && (o = o.map), google.maps.event.addListenerOnce(o, t, n);
        }),
        (f.fire = function (t, o, n) {
            if (-1 == f.custom_events.indexOf(t))
                google.maps.event.trigger(o, t, Array.prototype.slice.apply(arguments).slice(2));
        ...
        "object" == typeof window.google &&
            ...
            (google.maps.Polygon.prototype.getBounds ||
                (google.maps.Polygon.prototype.getBounds = function (t) {
                    for (
                        var o, n = new google.maps.LatLngBounds(), r = this.getPaths(), s = 0;
                        s < r.getLength();
                        s++
                    ) {
                        o = r.getAt(s);
                ...
                (google.maps.Polygon.prototype.containsLatLng = function (t) {
                    ...
                    for (var n = !1, r = this.getPaths().getLength(), s = 0; s < r; s++)
                        for (var i = this.getPaths().getAt(s), a = i.getLength(), l = a - 1, p = 0; p < a; p++) {
                            var c = i.getAt(p),
                                h = i.getAt(l);
                            ((c.lng() < t.lng() && h.lng() >= t.lng()) || (h.lng() < t.lng() && c.lng() >= t.lng())) &&
                                c.lat() + ((t.lng() - c.lng()) / (h.lng() - c.lng())) * (h.lat() - c.lat()) < t.lat() &&
                                (n = !n),
                                (l = p);
                        }
                    return n;
            ...
            google.maps.Circle.prototype.containsLatLng ||
                (google.maps.Circle.prototype.containsLatLng = function (t) {
                    return (
                        ...
                        google.maps.geometry.spherical.computeDistanceBetween(this.getCenter(), t) <= this.getRadius()
                    );
                }),
            ...
            (Array.prototype.indexOf = function (t) {
                ...
                if (
                    (arguments.length > 1 &&
                        ...
                        r != r
                            ? (r = 0)
                            : 0 != r && r != 1 / 0 && r != -1 / 0 && (r = (r > 0 || -1) * Math.floor(Math.abs(r)))),
                    r >= n)
                )
                    return -1;
